    ...
    if ($_POST['submit']) {
        ...
        $dbh = new mysqli("localhost", "root", "", "textkit");
        ...
        $result=$dbh->prepare("INSERT INTO images (image_number,image_data,filename,filesize,filetype) 
      ...
      $result = $dbh->prepare("SELECT * FROM images");
      var_dump($result);
      $result->execute(); 
      ;
